...
const outputDirectory = resolve('outputs/evidence/browser/p6-t6-ci16-raster-predecode')
      ...
      try {
        for (const theme of ['day', 'night']) {
          ...
          await page.screenshot({
            animations: 'allow',
            path: resolve(outputDirectory, `public-home-${theme}-${capture.name}.png`),
          })
          ...
          await page.screenshot({
            animations: 'allow',
            path: resolve(outputDirectory, `public-login-${theme}-${capture.name}.png`),
          })
